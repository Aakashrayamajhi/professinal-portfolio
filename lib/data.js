...
export const stack = [
  ...
  },
  {
    ...
    items: ["React", "React Native", "Tailwind CSS", "OpenAI APIs", "LangChain", "RAG", "n8n", "Pandas", "Scikit-learn"],
  },
  {
...
export const journey = [
  {
    ...
    description:
      "Before transitioning into software engineering, served as the In-Game Leader for multiple Free Fire teams and represented Nepal at national and international levels. Won 3-nation, 4-nation, and 7-nation tournaments multiple times, while earning repeated top-three finishes in official competitions across fields of millions of teams. The experience developed strategic decision-making, clear communication, and composure under pressure.",
  },
  {
    period: "2022 — 2026",
  ...
  },
  {
    ...
    title: "UPGRADING...",
    description:
      "Always building, learning, and preparing for what comes next.",
  },
];
...
export const projects = [
  ...
  {
    slug: "content-identity-system",
    name: "TraceMark",
    tagline: "A dependency-free prototype for detecting image reuse.",
    description:
      "A plain Node.js content provenance system built with a focus on protecting creators and businesses from the roughly $50 billion digital piracy problem by detecting exact and modified image reuse.",
    bullets: [
      "LSB watermarking repeated across pixels for resilient exact-match detection",
      "8x8 average-hash comparison recognizes resized and recompressed images",
      "AES-256-GCM metadata encryption with a JSON registry and detection history",
      "Shared CLI and local web server workflows for registration and detection",
    ],
    tech: ["Node.js", "Cryptography", "Steganography", "Perceptual Hashing", "PNG", "REST APIs", "System Design"],
    video: "/videos/tracemark.mp4",
    link: "https://github.com/Aakashrayamajhi",
    tone: "navy",
  },
];
